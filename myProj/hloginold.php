...
if($email!=''&&$password!='')
 {
   $query=mysqli_query($conn,"select * from signup where email='".$email."' and password='".$password."'") or die(mysqli_error());
   $res=mysqli_fetch_row($query);
   if($res)
   {
    $_SESSION['email']=$email;
    header('location:webProj.html');
   }
   else
   {?>
<script>
...
$sql="INSERT into comments values('$name','$email','$contact','$address','$message')";
...
<a href="webProj.html"><b>Home</b><i class="fas fa-gift"></i></a>
...
<tr>
    ...
    <td><input type="text" placeholder="Your email" name="email" id="email" required><br/><br/></td>
</tr>

<tr>
  <!-- <td> <label for="uname"><b>Email</b></label></td>-->
    <td><input type="password" placeholder="Password" name="password" id="password" required><br/><br/></td>
</tr>
...
<p><b><mark>New user?</mark></b> <a href="hsign.php"><mark1>Sign-up here</mark1></a></p>
...
<div class="form-popup" id="myForm">
  ...
  <form action="hlogin.php" class="form-container" method="post"> 
